    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='imp_bu.impbu')),
                ('resourceid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='imp_resource.resource')),
            ],
            options={
                'db_table': 'imp_budln',
            },
